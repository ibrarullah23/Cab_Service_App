...
//    private int ridesTaken , Earning;
    public CaptainMenu() {
//        FlatLightLaf.setup();
        initComponents();
    }

    public CaptainMenu(String id, String name, String phone, String CNIC, String email, String username, String pass , String ridestaken , String earning) {
        this.id = id;
        this.name = name;
        this.phone = phone;
        this.CNIC = CNIC;
        ...
        this.pass = pass;
//        this.ridesTaken = Integer.parseInt(ridestaken);
//        this.Earning = Integer.parseInt(earning);
        ...
        btnEarnings.setText("Total Earning  Rs : "+ earning);
        btnRidesHistory.setText("Recent Rides #"+ridestaken );
...
//        btnNoRides.setText( +" Rides Taken");
    ...
    private void initComponents() {
        ...
        btnRidesHistory = new javax.swing.JButton();
        jPanel4 = new javax.swing.JPanel();
        jLabel4 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setMinimumSize(new java.awt.Dimension(756, 496));
        setPreferredSize(new java.awt.Dimension(756, 496));
        setResizable(false);
        ...
        btnEdit.setMinimumSize(new java.awt.Dimension(0, 24));
        ...
        btnSave.setMinimumSize(new java.awt.Dimension(0, 24));
        ...
        jButton2.setText("Available Rides");
        ...
        btnEarnings.setText("Rides History");
        ...
        btnRidesHistory.setBackground(new java.awt.Color(79, 166, 241));
        btnRidesHistory.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        btnRidesHistory.setForeground(new java.awt.Color(255, 255, 255));
        btnRidesHistory.setText("Rides History");
        btnRidesHistory.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRidesHistoryActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnRidesHistory, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnEarnings, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(11, 11, 11)
                .addComponent(btnRidesHistory, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel4.setText("Captain Dashboard");
    ...
    private void btnRidesHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRidesHistoryActionPerformed
        // TODO add your handling code here:
        new RideHistory("select * from Rides where Captain='"+username+"'").setVisible(true);
    }//GEN-LAST:event_btnRidesHistoryActionPerformed
...
//                btnSave.setEnabled(false);
                ...
                try {
                    DataBaseConnection.updateData("UPDATE Captains SET FullName='"+txtName.getText().trim()
                            +"', Phone='"+txtphone.getText().trim()
                            +"', CNIC='"+txtCNIC.getText().trim()
                            +"', Email='"+txtEmail.getText().trim()
                            +"', Password='"+ txtPass.getText() +"' WHERE ID='"+id+"' ");
                    new Message("Captain Details Updated...", 1555, this);
                } catch (Exception e) {
                }
            }
...
//        txtUsername.setEditable(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new AvailableRides(username).setVisible(true);
    ...
    private void btnEarningsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEarningsActionPerformed
        // TODO add your handling code here:
        try {
            ResultSet rs = DataBaseConnection.getData("select * from Captains where ID='"+id+"'");
            if(rs.next()){
                btnEarnings.setText("Total Earning  Rs : "+ rs.getString("Earning"));
                btnRidesHistory.setText("Recent Rides #"+rs.getString("RidesTaken") );
            }
    ...
    private javax.swing.JButton btnRidesHistory;
